...
# Evaluate the complete simulation grid; Figure 3 retains four reference cells.
...
const BACKGROUND_SAMPLE_SIZE = 180
...
const FIGURE_CORRELATIONS = [CORR_RANGE[1], CORR_RANGE[2]]

const BASE_SEED = 20260805
const PIPELINE_VERSION = "sdm-full-continuum-v5"
